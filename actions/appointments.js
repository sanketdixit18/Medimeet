...
// // Initialize Vonage Video API client
// // Handles all Vercel env var formats: real newlines, escaped \n, or base64
// function getPrivateKey() {
//   const raw = process.env.VONAGE_PRIVATE_KEY || "";
//   // If it already looks like a PEM key, normalize newlines and return as Buffer
//   if (raw.includes("BEGIN")) {
//     const normalized = raw.replace(/\\n/g, "\n").replace(/\r\n/g, "\n");
//     return Buffer.from(normalized);
//   }
//   // Otherwise treat as base64-encoded PEM
//   try {
//     const decoded = Buffer.from(raw, "base64").toString("utf8");
//     if (decoded.includes("BEGIN")) return Buffer.from(decoded);
//   } catch (_) {}
...
// async function createVideoSession() {
//   try {
//     // Debug: log key info (safe — no actual key content exposed)
//     const raw = process.env.VONAGE_PRIVATE_KEY || "";
//     console.log("[vonage-debug] key length:", raw.length);
//     console.log("[vonage-debug] has BEGIN:", raw.includes("BEGIN"));
//     console.log("[vonage-debug] has escaped \\n:", raw.includes("\\n"));
//     console.log("[vonage-debug] appId:", process.env.NEXT_PUBLIC_VONAGE_APPLICATION_ID?.substring(0, 8) + "...");
...
//     const now = new Date();
//     const timeDifference = (new Date(appointment.startTime) - now) / (1000 * 60);
//     if (timeDifference > 30) {
